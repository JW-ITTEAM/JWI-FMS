...
export const API_URL_SIGN_UP_PROCESS: string = "/api/Account/SignUp";
export const API_URL_DB_CURRENT_USER: string = "/api/Account/getDbCurrentUser";

// export const FIREBASE_JW_WEB_API_KEY: string =
//   "AIzaSyBWvOh5KL16jU-rD2mYt-OY7hIhnCMBZ60";
export const FIREBASE_WEB_FMS_API_KEY: string =
  "AIzaSyDrpPIPp8w6Bjke-RxNmyzR_bw0RYl52as";
